            ...
            <div >
                    ...
                    {allInterests.map(interest => {
                            ...
                            if(x!==-1){
                                ...
                                return <div className="interestCardsStyle">
                                <Card3 interest={interest} docid={myInterest[x].docid} isSelected={true} callFunc={callInterest} desc="you can talk about healthy things here."/>  
                                </div>
                            }else{
                                return <div className="interestCardsStyle">
                                <Card3 interest={interest} isSelected={false} callFunc={callInterest} desc="you can talk about healthy things here."/>  
                                </div>
