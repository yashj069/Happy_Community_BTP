...
async function addToMyTag(interest,user) {
    try {
        console.log("clicked");
        await addDoc(collection(db, 'user', user.uid,'myInterests'), {tag:interest});
        console.log("added");
...
export { loginWithGoogle, sendMessage, getMessages,deleteMyCommunity,sendContactDetail,addToMyCommunity,addToMyTag,deleteMyTag,db};
